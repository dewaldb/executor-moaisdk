...
function _M.init()
    ...
    if _M.touchDevice == false then
        ...
        MOAIInputMgr.device.touch:setCallback(_M.onTouchEvent)
    end
...
function _M.onTouchEvent(eventType, idx, x, y, tapCount)
    _M.onPointerEvent(x, y)
    ...
    if eventType == MOAITouchSensor.TOUCH_DOWN then
        _M.onMouseLeftEvent(true)
    elseif eventType == MOAITouchSensor.TOUCH_UP then
        _M.onMouseLeftEvent(false)
    end
end
